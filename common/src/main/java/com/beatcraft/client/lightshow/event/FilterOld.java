...
public class FilterOld implements Iterable<Triplet<Integer[], Float, Float>> {


    public static FilterOld processFilter(int lightCount, ArrayList<Integer> coveredIds, JsonObject filter) {
    ...
    private final ArrayList<Triplet<Integer[], Float, Float>> targets;
    ...
    public FilterOld(int start, int end, int lightCount, int randomBehavior, int randomSeed, int chunkSize, int limitBehavior, float limitPercent, ArrayList<Integer> coveredIds) {
        this(
    ...
    public FilterOld(int start, int step, int count, int lightCount, int randomBehavior, int randomSeed, int chunkSize, int limitBehavior, float limitPercentage, ArrayList<Integer> coveredIds) {
        this.start = start;
        this.step = step;
        this.count = count;
    ...
    public static class FilterIterator implements Iterator<Triplet<Integer[], Float, Float>> {
        ...
        private final FilterOld filter;
        private int index = 0;

        public FilterIterator(FilterOld filter) {
            this.filter = filter;
        }
