...
public class RingLightHandlerOld extends LightObject {
    ...
    protected static class RingHandler {
        private final RingLightHandlerOld controller;
        ...
        protected RingHandler(RingLightHandlerOld controller, int index, LightObject ringLight) {
    ...
    @Override
    public RingLightHandlerOld cloneOffset(Vector3f offset) {
        return this;
    }
