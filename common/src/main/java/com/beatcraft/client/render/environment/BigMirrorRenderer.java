...
public class BigMirrorRenderer implements EnvironmentRenderer {
    ...
    private static final float PARALLEL_Y = -0.5f;
    ...
    private static final float[][][] blocksMesh = new float[][][]{
        ...
        { // Runway pillars
            {-RUNWAY_WIDTH_PILLARS,                      RUNWAY_BOTTOM,        RUNWAY_START},
            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH,  RUNWAY_BOTTOM,        RUNWAY_START},
            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH, -RUNWAY_PILLAR_HEIGHT, RUNWAY_START},
            {-RUNWAY_WIDTH_PILLARS,                     -RUNWAY_PILLAR_HEIGHT, RUNWAY_START},

            {-RUNWAY_WIDTH_PILLARS,  RUNWAY_BOTTOM,        RUNWAY_START},
            {-RUNWAY_WIDTH_PILLARS,  RUNWAY_BOTTOM,        RUNWAY_START+RUNWAY_PILLAR_WIDTH},
            {-RUNWAY_WIDTH_PILLARS, -RUNWAY_PILLAR_HEIGHT, RUNWAY_START+RUNWAY_PILLAR_WIDTH},
            {-RUNWAY_WIDTH_PILLARS, -RUNWAY_PILLAR_HEIGHT, RUNWAY_START},

            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH,  RUNWAY_BOTTOM,        RUNWAY_START+RUNWAY_PILLAR_WIDTH},
            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH,  RUNWAY_BOTTOM,        RUNWAY_START},
            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH, -RUNWAY_PILLAR_HEIGHT, RUNWAY_START+RUNWAY_PILLAR_WIDTH},
            {-RUNWAY_WIDTH_PILLARS+RUNWAY_PILLAR_WIDTH, -RUNWAY_PILLAR_HEIGHT, RUNWAY_START},
