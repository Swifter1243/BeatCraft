...
import com.beatcraft.client.menu.SettingsMenu;
...
public class SettingsMenuPanel extends MenuPanel<SettingsMenu> {
    public SettingsMenuPanel(HUDRenderer hudRenderer) {
        super(new SettingsMenu(hudRenderer));
        backgroundColor = 0;
    ...
    private void initLayout() {
        ...
        selected = BeatcraftClient.playerConfig.controller.activeIndex();
        var profile = BeatcraftClient.playerConfig.controller.activeProfile();
    ...
    private void back() {
        BeatcraftClient.playerConfig.controller.selectProfile(selected-1);
        refresh = true;
    }
    ...
    private void addProfile() {
        BeatcraftClient.playerConfig.controller.addProfile();
