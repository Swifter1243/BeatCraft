...
public class ControllerProfile {
    ...
    public Quaternionf getLeftRotation() {
        return (new Quaternionf()).rotationYXZ(leftRotation.y * Mth.DEG_TO_RAD, leftRotation.x * Mth.DEG_TO_RAD, leftRotation.z * Mth.DEG_TO_RAD);
    }

    public Quaternionf getRightRotation() {
        return (new Quaternionf()).rotationYXZ(rightRotation.y * Mth.DEG_TO_RAD, rightRotation.x * Mth.DEG_TO_RAD, rightRotation.z * Mth.DEG_TO_RAD);
    }
