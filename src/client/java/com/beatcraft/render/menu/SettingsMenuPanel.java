        ...
        if (selected >= 0) {
            ...
            widgets.addAll(List.of(
                ...
                getOptionModifier("Left rotation X",
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(-0.01f, 0, 0), 0, -0.1f, 0.1f)),
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(0.01f, 0, 0), 0, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getLeftRotationEuler().x),
                    new Vector3f(LEFT, 50, -0.01f)),
                getOptionModifier("Left rotation Y",
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(0, -0.01f, 0), 1, -0.1f, 0.1f)),
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(0, 0.01f, 0), 1, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getLeftRotationEuler().y),
                    new Vector3f(LEFT, 100, -0.01f)),
                getOptionModifier("Left rotation Z",
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(0, 0, -0.01f), 2, -0.1f, 0.1f)),
                    () -> profile.setLeftRotation(clampVector3(profile.getLeftRotationEuler().add(0, 0, 0.01f), 2, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getLeftRotationEuler().z),
                ...
                getOptionModifier("right rotation X",
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(-0.01f, 0, 0), 0, -0.1f, 0.1f)),
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(0.01f, 0, 0), 0, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getRightRotationEuler().x),
                    new Vector3f(RIGHT, 50, -0.01f)),
                getOptionModifier("right rotation Y",
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(0, -0.01f, 0), 1, -0.1f, 0.1f)),
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(0, 0.01f, 0), 1, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getRightRotationEuler().y),
                    new Vector3f(RIGHT, 100, -0.01f)),
                getOptionModifier("right rotation Z",
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(0, 0, -0.01f), 2, -0.1f, 0.1f)),
                    () -> profile.setRightRotation(clampVector3(profile.getRightRotationEuler().add(0, 0, 0.01f), 2, -0.1f, 0.1f)),
                    () -> String.format("%.2f", profile.getRightRotationEuler().z),
