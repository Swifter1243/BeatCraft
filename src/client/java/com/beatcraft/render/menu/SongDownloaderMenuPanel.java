...
public class SongDownloaderMenuPanel extends MenuPanel<SongDownloaderMenu> {
    ...
    private static class SongPreviewWidget extends Widget {
        ...
        protected SongPreviewWidget(SongPreview preview, Vector3f position, Runnable previewDisplayer) {
            ...
            children.addAll(List.of(
                ...
                new TextWidget(preview.name(), new Vector3f(2, -15, 0)).alignedLeft().withScale(2).withDynamicScaling(LIST_MAX_WIDTH),
                new TextWidget(preview.uploaderData().name(), new Vector3f(6, 3, 0)).alignedLeft().withScale(1.5f).withColor(0xFFAAAAAA).withDynamicScaling((int) (LIST_MAX_WIDTH*1.3333f))
    ...
    private void initLayout() {
        ...
        widgets.addAll(List.of(
            ...
            SettingsMenuPanel.getButton(
                ...
                new Vector3f(125, -225, 0), new Vector2f(45, 45)
            ),
            resultsContainer,
            previewContainer
        ));
    ...
    private void setPreview(SongPreview data) {
        ...
        previewContainer.children.addAll(List.of(
            new TextWidget(data.id(), new Vector3f(0, -25, 0.01f), 1f).withDynamicScaling(DISPLAY_WIDTH),
