...
public enum ClassIdType {
    ...
    private static final HashMap<Integer, ClassIdType> lookupTable = new HashMap<>(500);
    public final int value;
    ClassIdType(int value) {
        this.value = value;
    }

    public static void init() {
        for (var val : values()) {
            lookupTable.put(val.value, val);
        }
    }

    public static ClassIdType fromId(int id) {
