...
public class NiceStructure implements EnvironmentPlacer {
    ...
    private static final List<Integer> skipPositions = List.of(-1, 0, 1, 2, -2, -3);
    ...
    private void generateRunway(ServerWorld world, boolean place) {
        ...
        for (int z = -207; z <= 300; z++) {
            world.setBlockState(new BlockPos(16, 1, z), state);
            world.setBlockState(new BlockPos(-17, 1, z), state);
        }
