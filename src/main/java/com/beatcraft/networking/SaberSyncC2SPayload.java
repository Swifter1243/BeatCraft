...
public record SaberSyncC2SPayload(Vector3f leftPos, Quaternionf leftRot, Vector3f rightPos, Quaternionf rightRot) implements CustomPayload {
    ...
    static PacketCodec<PacketByteBuf, SaberSyncC2SPayload> CODEC = CustomPayload.codecOf(SaberSyncC2SPayload::write, SaberSyncC2SPayload::read);
    static CustomPayload.Id<SaberSyncC2SPayload> ID = new Id<>(BeatCraftNetworking.SABER_SYNC_C2S_PAYLOAD);
